...
const navItems = [
  ...
  { name: 'Senders & DNS', href: '/senders', icon: ShieldCheck },
  ...
  return (
    <aside className="w-64 bg-[#0B0F19] text-[#94A3B8] border-r border-[#1E293B] flex flex-col h-full shrink-0">
      ...
      <div className="h-16 flex items-center px-6 border-b border-[#1E293B] gap-3">
        ...
        <div>
          <h1 className="font-bold text-white tracking-wide text-md">OutreachEngine</h1>
          <span className="text-xs text-[#6366F1] font-semibold tracking-wider uppercase">Private Cloud</span>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-[#1E293B] bg-[#0E1527]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-semibold text-white">System Active</p>
            <p className="text-[10px] text-[#475569]">All queues operational</p>
          </div>
        </div>
      </div>
    </aside>
